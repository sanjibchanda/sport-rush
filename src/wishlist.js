  ...
  container.innerHTML = wishlistProducts.map(product => `
    <div class="flex gap-4 py-4 border-b border-border">
        ...
        <div class="space-y-1 w-full">
            ...
            <p class="text-sm">
            <span class="font-medium">Color:</span> <span>Black</span>
            </p>
            <p class="text-sm">
            <span class="font-medium">Size:</span> <span>6</span>
            </p>
        </div>
        <div class="flex flex-col justify-between items-end">
            <button class="text-muted hover:text-accent remove-wishlist" data-id="${product.id}">
